...
function projectDescription(config: ProjectConfig) {
  switch (config.type) {
    case 'react':
    case 'vue':
      return `A ${config.type} project generated by @sayoriqwq/prelude`
    case 'workspace-root':
      return 'A pnpm workspace root generated by @sayoriqwq/prelude'
    case 'node':
      return 'A Node project generated by @sayoriqwq/prelude'
    case 'cli':
      return 'A CLI tool generated by @sayoriqwq/prelude'
    case 'library':
      return 'A library package generated by @sayoriqwq/prelude'
    default: {
