...
import { reactPresetProjectConfig, workspaceRootProjectConfig } from '../support/fixtures'
...
describe('workspace/bootstrap contract', () => {
  ...
  it('keeps workspace root lint policy on Turborepo orchestration when linting is enabled', () => {
