...
const dryRunCases: readonly DryRunCase[] = [
  ...
  {
    label: 'workspace cli library preset',
    preset: 'workspace-cli-library',
    projectName: 'smoke-workspace-cli-library-dry-run',
    flags: ['--no-git'],
    expected: [
      'Dry run preview',
      'Root files:',
      ...
      '- json apps/cli/package.json (owner: cli-package, unit: json-text-mutation)',
      '- render apps/cli/src/index.ts (owner: cli-scaffold, unit: fragment-render)',
      '- json libs/core/package.json (owner: library-package, unit: json-text-mutation)',
      '- render libs/core/src/index.ts (owner: library-package, unit: fragment-render)',
      'owner: cli-scaffold, unit: json-text-mutation',
      'owner: library-package, unit: json-text-mutation',
    ],
  },
  {
    label: 'workspace fullstack react preset',
    preset: 'workspace-fullstack-react',
    projectName: 'smoke-workspace-fullstack-react-dry-run',
    flags: ['--no-git'],
    expected: [
      'Dry run preview',
      'Workspace package files:',
      '- json apps/web/package.json (owner: frontend-package, unit: json-text-mutation)',
      '- json apps/api/package.json (owner: node-package, unit: json-text-mutation)',
      '- json libs/shared/package.json (owner: library-package, unit: json-text-mutation)',
      'owner: frontend-scaffold, unit: fragment-render',
      'owner: node-scaffold, unit: fragment-render',
      'owner: library-package, unit: fragment-render',
    ],
  },
  {
    label: 'workspace fullstack vue preset',
    preset: 'workspace-fullstack-vue',
    projectName: 'smoke-workspace-fullstack-vue-dry-run',
    flags: ['--no-git'],
    expected: [
      'Dry run preview',
      'Workspace package files:',
      ...
      '- json apps/api/package.json (owner: node-package, unit: json-text-mutation)',
      '- json libs/shared/package.json (owner: library-package, unit: json-text-mutation)',
      'owner: vue-scaffold, unit: fragment-render',
      'owner: node-scaffold, unit: fragment-render',
      'owner: library-package, unit: fragment-render',
    ],
  },
  ...
  {
    label: 'backend full preset',
    preset: 'standalone-backend-full',
    projectName: 'smoke-backend-full-dry-run',
    flags: ['--no-git'],
    expected: [
      'Dry run preview',
      '- render src/index.ts (owner: node-scaffold, unit: fragment-render)',
      '- render eslint.config.mjs (owner: workspace-bootstrap, unit: fragment-render)',
      'owner: node-scaffold, unit: json-text-mutation',
      'owner: workspace-bootstrap, unit: json-text-mutation',
    ],
  },
  {
    label: 'library minimal preset',
    preset: 'standalone-library-minimal',
    projectName: 'smoke-library-minimal-dry-run',
    flags: [],
    expected: [
      'Dry run preview',
      '- render src/index.ts (owner: library-package, unit: fragment-render)',
      '- render tsconfig.json (owner: library-package, unit: fragment-render)',
      '- render tsdown.config.ts (owner: library-package, unit: fragment-render)',
      'owner: library-package, unit: json-text-mutation',
    ],
  },
  {
    label: 'library node preset',
    preset: 'standalone-library-node',
    projectName: 'smoke-library-node-dry-run',
    flags: [],
    expected: [
      'Dry run preview',
      '- render src/index.ts (owner: library-package, unit: fragment-render)',
  ...
  {
    label: 'cli full preset',
    preset: 'standalone-cli-full',
    projectName: 'smoke-cli-full-dry-run',
    flags: ['--no-git'],
    expected: [
      'Dry run preview',
      '- render src/index.ts (owner: cli-scaffold, unit: fragment-render)',
